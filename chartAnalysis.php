...
<div class="row gx-lg-5 ">
                          ...
                          <div class="col-6 text-end">
                                <form action="" class="myForm" onSubmit="return false">
                                  <div class="form-outline m-2">
                                    ...
                                    <label class="form-label text-white" for="form12">Start Date</label>
                                  </div>
                                  <div class="form-outline m-2">
                                    <input type="date" id="endDate" name="endDate" class="form-control text-white" />
                                    <label class="form-label text-white" for="form12">End Date</label>
                                  </div>
                                  <div class="form-outline m-2">
                                  <input list="chooseMda1"   class="chooseMda1 form-control text-white" />
                                     <datalist  id="chooseMda1" name="chooseMda1">
                                     
                                     </datalist>
                                    <label class="form-label text-white">Choose MDA</label>
                                  </div> 
  ...
  <div class=" bg-glass shadow-4-strong rounded-6">
                ...
                <div class="row align-items-center">
                      ...
                      <form action="" class="myForm" onSubmit="return false">
                         ...
                         <!--    \      <script src="js/ticketFormLogic.js"></script> -->
                                  <div class="form-outline m-2">
                                  <input list="chooseMda"   class="chooseMda form-control text-white" />
                                     <datalist  id="chooseMda" name="chooseMda">
                                  ...
                                  <input list="chooseMda"  type="text" id="chooseMda"  name="chooseMda" class="form-control text-white" />
                                  <label class="form-label text-white">Choose MDA</label>
                                  
                                  <input list="chooseMda"  class="form-control text-white" />
                                     <datalist  id="chooseMda" name="chooseMda">
      ...
      <!-- card body -->
              ...
              <div class="chartDisplay p-2"><canvas id="closedChart" height="243px" class="text-white"></div>
              </div>
