...
?>
    ...
    <!-- section table -->
      ...
      <script src="js/tableSearch.js"></script>
        ...
        <div class="table-responsive ticket_records bg-glass shadow-4-strong rounded-6" style="overflow-y: scroll !important; max-height: 800px !important">
          <!-- table goes here! -->
...
$(document).on('change', '.chooseMda1,#startDate,#endDate', function(){

            const startDate = $('#startDate').val();
            const endDate = $('#endDate').val();
            const chooseMda1 = $('.chooseMda1').val();
            
            $.ajax({
          type: "post",
          url:"getDates.php",
          data: {startDate:startDate, endDate:endDate, chooseMda1:chooseMda1},
          dataType:'json',
          cache:false,
...
<div id="messages" class="table-responsive" style="overflow-y: scroll !important; height: 400px !important;"></div>
