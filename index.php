...
if (isset($_SESSION['email'])){
  header("location: https://edoictaservices.com.ng/helpdesk/dashboard.php");
...
<div class="tab-content">
  ...
  <form id="myForm2" >
    ...
    <center><span><b class="forgot btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" >Forgotten Password?</b></span></center>
  </form>
...
<div class="input-group mb-3 m-2">
  ...
  <div class="input-group mb-3 m-2">
    <button type="submit" class="form-control  btn btn-success p-2"  >UPDATE PASSWORD </button>
      ...
      <center><p><span style="color:red"><i class="fa fa-envelope fa-md" aria-hidden="true"></i></span> Email Us Via: helpdesk@edostate.gov.ng</p></center>
      </div>
    </div>
  </div>
</div>
...
<p><span style="color:red"><i class="fa fa-envelope fa-md" aria-hidden="true"></i></span> Email Us Via: helpdesk@edostate.gov.ng</p>
</div><!-- end of footer --> 
