...
($commentBy == $fullnames ) ?   $msgBox .= ' <div class="holder_ darker">
<span style="font-size:16px !important; font-family:tahoma !important; color:#ffffff">'.$commentBy.'</span>
<p>'.$commentsBody.'</p>
<span class="time-left">'.$created_at .' - '.$agoTime.'</span>
</div>' :    $msgBox .= ' <div class="holder_ " style="color:#000000 !important;">
