...
if (isset($_POST['ticketNo']) && isset($_SESSION['email']) ||  isset($_SESSION['access_level'])==2 ||  isset($_SESSION['access_level'])==3 ||  isset($_SESSION['access_level'])==4  ){
...
if (mysqli_num_rows($result) > 0)
{
       ...
       $date_issued = date('M d Y', $date_issued); 
               ...
               if ($actionOnTickets == "Opened" ){
                ...
                $_SESSION['access_level'] ==1 ? $takeActionOnTicket .="" :  $takeActionOnTicket = '<div class="btn-group dropstart">
