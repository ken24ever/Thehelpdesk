                  ...
                  ';
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                         ...
                         if ($actionOnTickets == "Opened" ){
                            ...
                            $actionOnTickets = '<td  class=" one" title="Click to edit ticket no: '.$ticket_no.'" ><button id='.$ticket_no.' class=" btn btn-primary">'. $actionOnTickets.'</button></td>';
                        }
                
                        if ($actionOnTickets == "Closed"){
                
                            $actionOnTickets  = '<td  class=" one" title="Click to edit ticket no: '.$ticket_no.'" ><button id='.$ticket_no.' class=" btn btn-success">'. $actionOnTickets.'</button></td>';
