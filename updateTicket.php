...
session_start();
  ...
  $commented_by = $_SESSION['fullnames'];
...
$result = mysqli_query($conn, $sql);
    ...
    if ($check < 1)
      {
        ...
        VALUES ('$ticket_no', '$issuerName', '$actionOnTickets','$commented_by', '$user_id', '$user_accsLvl', '$createdDateAndTime', '$time')";
    ...
    VALUES ('$ticket_no', '$createdDateAndTime', '$issuerName', '$commented_by', '$message', '$time')";
